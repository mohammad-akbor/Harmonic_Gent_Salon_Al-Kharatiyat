  ...
  return (
    <div className="min-h-screen pb-16">
        ...
        <div className="max-w-5xl mx-auto px-4 py-3 flex flex-wrap gap-3 items-center justify-between">
          <div>
            ...
            <h1 className="text-xl font-bold">
              {isAdmin ? "Admin / Staff Dashboard" : "Staff Dashboard"}
            </h1>
            <p className="text-xs text-slate-400">
              Complete booking + payment · commission on profile
            </p>
          </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-6 space-y-4">
        {/* Quick access — NOT public; only logged-in staff/admin */}
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
          <Link href="/booking" className="glass rounded-xl p-3 text-center text-sm hover:ring-1 hover:ring-[#d4af37]/40">
            + New Booking
          </Link>
          <Link href="/attendance" className="glass rounded-xl p-3 text-center text-sm hover:ring-1 hover:ring-[#d4af37]/40">
            Attendance
          </Link>
          <Link href="/daily-entry" className="glass rounded-xl p-3 text-center text-sm hover:ring-1 hover:ring-[#d4af37]/40">
            Daily Entry
          </Link>
          <Link href="/settings" className="glass rounded-xl p-3 text-center text-sm hover:ring-1 hover:ring-[#d4af37]/40">
            Settings / Photo
          </Link>
          {isAdmin && (
            <>
              <Link href="/inventory" className="glass rounded-xl p-3 text-center text-sm bg-[#d4af37]/15 text-[#d4af37] font-semibold hover:ring-1 hover:ring-[#d4af37]/40">
                Inventory / Buy
              </Link>
              <Link href="/finance" className="glass rounded-xl p-3 text-center text-sm bg-emerald-500/15 text-emerald-300 font-semibold hover:ring-1 hover:ring-emerald-400/40">
                Finance / P&L
              </Link>
              <Link href="/admin" className="glass rounded-xl p-3 text-center text-sm hover:ring-1 hover:ring-[#d4af37]/40">
                Admin Panel
              </Link>
              <Link href="/customers" className="glass rounded-xl p-3 text-center text-sm hover:ring-1 hover:ring-[#d4af37]/40">
                Customers
              </Link>
              <Link href="/salary" className="glass rounded-xl p-3 text-center text-sm hover:ring-1 hover:ring-[#d4af37]/40">
                Salary
              </Link>
              <Link href="/admin/offers" className="glass rounded-xl p-3 text-center text-sm hover:ring-1 hover:ring-[#d4af37]/40">
                Offers
              </Link>
              <Link href="/whatsapp" className="glass rounded-xl p-3 text-center text-sm hover:ring-1 hover:ring-[#d4af37]/40">
                WhatsApp
              </Link>
              <Link href="/reports/monthly" className="glass rounded-xl p-3 text-center text-sm hover:ring-1 hover:ring-[#d4af37]/40">
                Reports
              </Link>
            </>
          )}
        ...
        <h2 className="text-sm font-semibold text-slate-400 pt-2">Today&apos;s bookings</h2>
