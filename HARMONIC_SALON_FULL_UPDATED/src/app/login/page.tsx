    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="glass card-3d rounded-3xl p-8 w-full max-w-md shadow-2xl">
        <div className="text-center mb-6">
          ...
          <p className="text-slate-400 text-sm mt-1">Customers register here · Staff & Admin use their accounts</p>
          <p className="text-xs text-slate-500 mt-2">After login → Customer: Home · Staff: Dashboard · Admin: Admin panel</p>
        </div>
