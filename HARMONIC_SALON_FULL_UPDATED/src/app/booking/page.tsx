...
function BookingInner() {
  ...
  useEffect(() => {
    ...
    setStaff(allStaff.filter((s: any) => !s.branchId || String(s.branchId) === form.branchId));
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <div className="space-y-1">
                <label className="text-sm text-slate-400">Branch / Location *</label>
                <select
                  required={branches.length > 0}
                  value={form.branchId}
                  onChange={(e) => setForm({ ...form, branchId: e.target.value, staffId: "", startTime: "" })}
